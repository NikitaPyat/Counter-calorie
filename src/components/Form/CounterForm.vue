...
<script>
import gender from './GenderForm.vue'
import bodyCharacteristics from './BodyСharacteristicsForm.vue'
import phisicalActivity from './PhisicalActivityForm.vue'
import getCleanResult from './ButtonsForm.vue'
